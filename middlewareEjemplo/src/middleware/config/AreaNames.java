...
public class AreaNames {
	...
	public static int Area1 = IDHelper.generateID("Area1", 0, 0);
	public static int A1Process1 = IDHelper.generateID("Area1", 1 , 0);
	public static int A1Process2 = IDHelper.generateID("Area1", 2 , 0);
